...
<head>
  ...
  <body style='background-image: url("./img/background.jpg")'>
	...
	<!-- Display total records and can go to last or next page. -->
	</div>
		<div class="contrain"><div class="col-md-3"></div><div class="col-md-8">Have <?php echo $count;?> Records，Each page display <?php echo $pagecount;?> record，Total <?php echo $pages;?> Page <?php echo $page;?> Page，<a href="list.php?page=<?php echo ($page == 1) ? $page : $page-1;?>" >Last Page</a>，<a href="list.php?page=<?php echo ($page == $pages) ? $pages : ($page + 1);?>">Next Page</a></div></div>
	</div>
