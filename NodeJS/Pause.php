...
$resumefile = 'E:/Assignments/WWW/NodeJs/resume.pdf';
...
// Your email address
$email = 'menglingchen3019@gmail.com';
...
$queryString = "";
$count = 0;
foreach($vars as $keyName => $item)
{
	$count++;
	$queryString .= $keyName .'=' .$item;
	if($count != count($vars)){
		$queryString .= '&';
	}
}
...
$signature = base64_encode(hash("sha256", $queryString, True)); //'This must be replaced by the code you generate in steps 1,2,3,4)';
var_dump($signature);
...
$vars['script'] = '@'.'E:/Assignments/WWW/NodeJs/Example.js';
